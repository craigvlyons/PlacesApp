...
- **Compact grouped row (superseded):** the final grouped presentation uses the same bold name, address, truncated notes, Map, and heart hierarchy as cards, without printing a city group heading.
